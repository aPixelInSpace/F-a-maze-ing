...
module Mazes.Core.Refac.Canvas.Array2D.Shape.TriangleIsosceles
...
let create baseLength baseAt baseDecrement heightIncrement =
    ...
    CanvasArray2D.create numberOfRows numberOfColumns (isCellPartOfTriangleIsosceles baseAt baseDecrement heightIncrement numberOfRows numberOfColumns)