...
module Mazes.CLI.Maze.RecursiveBacktracker
...
[<Verb(verb, isDefault = false, HelpText = "Recursive backtracker algorithm")>]
type Options = {
...
let handleVerb ndStruct (options : Parsed<Options>) =
    ...
    ndStruct |> RecursiveBacktracker.createMaze seed