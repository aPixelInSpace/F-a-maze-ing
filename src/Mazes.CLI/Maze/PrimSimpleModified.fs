...
module Mazes.CLI.Maze.PrimSimpleModified
...
[<Verb(verb, isDefault = false, HelpText = "Prim's simple modified algorithm")>]
type Options = {
...
let handleVerb ndStruct (options : Parsed<Options>) =
    ...
    ndStruct |> PrimSimpleModified.createMaze seed